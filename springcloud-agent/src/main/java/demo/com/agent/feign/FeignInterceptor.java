package demo.com.agent.feign;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;

import demo.com.agent.exception.AuthenticationServerErrorException;
import demo.com.agent.exception.AuthenticationVerifyFailException;
...
public class FeignInterceptor implements RequestInterceptor {
    ...
    private static String authHost;// 定义为static,因为该类中,用到该参数静态值
    ...
    public FeignInterceptor(String clientId, String secret, String header, String authHost, String tokenHead) {
        ...
        FeignInterceptor.authHost = authHost;
